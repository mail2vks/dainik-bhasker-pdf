...
public class Init {
    ...
    public static void main(String[] args) throws IOException,
        ...
        displayAvailableOptions(args);

    }

    private static void displayAvailableOptions(String[] args) throws IOException, COSVisitorException {
        ...
        if (args.length == 0) {
            ...
            displayAvailableOptions(new String[]{});
        }
        else {
            if (!cityToConfigMap.containsKey(StringUtils.upperCase(args[0]))) {
                logInfo("Invalid city name given as argument : " + args[0]);
                return;
            }
            generatePDFForCity(cityToConfigMap.get(StringUtils.upperCase(args[0])));
        }
